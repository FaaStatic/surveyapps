...
class _$ParticipantModelImpl implements _ParticipantModel {
  ...
  @override
  String toString() {
    return 'ParticipantModel(nik: $nik, name: $name, departement: $departement, departementId: $departementId, role: $role, roleId: $roleId, siteLocation: $siteLocation, siteLocationId: $siteLocationId, totalAssessment: $totalAssessment, lastAssessment: $lastAssessment, imageProfile: $imageProfile, createdAt: $createdAt)';
  }
