...
class _$UserLoginModelImpl implements _UserLoginModel {
  ...
  @override
  String toString() {
    return 'UserLoginModel(userId: $userId, nik: $nik, systemRoleId: $systemRoleId, systemRole: $systemRole, name: $name, email: $email, phone: $phone, departementId: $departementId, departement: $departement, siteLocationId: $siteLocationId, siteLocation: $siteLocation)';
  }
